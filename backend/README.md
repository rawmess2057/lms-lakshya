...
- If email is not configured, the app will still run but email sending will be disabled
...
- `POST /auth/forgotpassword` - Request password reset (sends email)
- `PUT /auth/resetpassword/:resettoken` - Reset password using token
