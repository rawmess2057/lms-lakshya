...
import { FiBook, FiPlay, FiAward, FiTrendingUp, FiFileText, FiCreditCard, FiClock, FiCheckCircle, FiXCircle } from 'react-icons/fi';
  ...
  const getStatusIcon = (status) => {
    switch (status) {
      ...
      case 'rejected':
        return <FiXCircle className="w-5 h-5 text-red-600" />;
      default:
        return <FiCreditCard className="w-5 h-5 text-gray-600" />;
    }
  };
