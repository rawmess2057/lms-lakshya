...
import { FiUsers, FiBook, FiTrendingUp, FiActivity, FiClock, FiCreditCard, FiAward, FiVideo } from 'react-icons/fi';
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        ...
        <Link to="/admin/teacher-requests" className="card hover:shadow-lg transition-shadow cursor-pointer">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-gray-600 dark:text-gray-400 text-sm">Pending Teacher Requests</p>
      ...
      <div className="card mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
          ...
          <Link to="/admin/teacher-requests" className="btn-outline text-center">
            Teacher Requests
          </Link>
          <Link to="/admin/session-config" className="btn-outline text-center">
            Session Config
          </Link>
          <Link to="/admin/highlights" className="btn-outline text-center">
            Manage Highlights
          </Link>
          <Link to="/admin/teachers" className="btn-outline text-center">
            Manage Teachers
          </Link>
          <Link to="/admin/counselling-requests" className="btn-outline text-center">
